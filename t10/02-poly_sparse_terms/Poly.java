...
public class Poly {
    ...
    */
    ...
    /**
    * Post-condizioni: restituisce un generatore che produce i termini di this con coefficiente diverso da 0
    *                  I termini vengono restituiti in ordine crescente rispetto all'esponente
    */
