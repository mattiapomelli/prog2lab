...
public class Poly {
    ...
    /**
    * Post-condizioni: restituisce un generatore che produce gli esponenti dei termini di this diversi da zero fino al grado di this.
    *                   Gli esponenti vengono restituiti in ordine crescente
    */
